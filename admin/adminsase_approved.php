         ...
         <a class="ui vertical menu" id="hybrid">
            <div class="ui dropdown item">
                ...
                <select onChange="window.location.href=this.value">
                    <option value="adminsase1.php">Scholars List</option>
                    <option>Approve Scholars</option>
                </select>
            </div>
        </a>
<!--
...
-->
                            <td><button class="tiny ui circular google plus icon button" id="{{user.sase_passers_list_id}}" onclick="disapprove(this.id,this)">
                                Disapprove
                            </button></td>
		...
		<script src="app/sase_approved.js"></script>
    ...
    <script type="text/javascript">
        ...
        function disapprove(id,row){
             $.ajax({
              type: "POST",
               url: "ajax/disapprove_sase_status.php",
               data: {
                  scho_id: id
               },
               success: function(data){
