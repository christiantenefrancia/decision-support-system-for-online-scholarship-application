<?php
    ...
    mysql_query("update sase_scholars_list set status='Pending' where sase_passers_list_id = $scho_id");
   ...
   $connection = mysqli_connect("localhost","root","","final_db") or die("Error " . mysqli_error($connection));
                    ...
                    inner join scholarship on sase_scholars_list.scholarship_id = scholarship.scholarship_id and sase_scholars_list.status='Approve'";
                   ...
                   //write to json file
                    $fp = fopen('../JSON/sase_data_approved.json', 'w');
    ...
    $connection = mysqli_connect("localhost","root","","final_db") or die("Error " . mysqli_error($connection));
                    ...
                    $sql = "select sase_passers_list.sase_passers_list_id,firstname,middlename,lastname,school,address,religion,tribe,year_passed,score,name from sase_passers_list
                    inner join sase_scholars_list on sase_passers_list.sase_passers_list_id = sase_scholars_list.sase_passers_list_id
                    inner join scholarship on sase_scholars_list.scholarship_id = scholarship.scholarship_id and sase_scholars_list.status='Pending'";
                    $result = mysqli_query($connection, $sql) or die("Error in Selecting " . mysqli_error($connection));
