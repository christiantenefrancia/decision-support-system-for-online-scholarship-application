...
?>
    ...
    <div class="ui five top attached steps">
      ...
      <div class="step" id="showEducation" onclick="stepChange(this.id)">
       ...
       <div class="step" id="showFile" onclick="stepChange(this.id)">
        <i class="file icon"></i>
        <div class="content">
...
-->
    ...
    <div class="ui segment" id="file" style="display: none;">
        <p>
        <hr>
        <div class="ui form">
<!--
...
-->         
    ...
    <div class="footer">
        <div class="actions">
            <button class="ui blue right labeled icon button" id="submitApplicant">
